...
rest_001,배곧 짬뽕관,restaurant,중식,/restaurants/rest_001.webp
rest_002,오후커피 로스터스,cafe,카페,/restaurants/rest_002.webp
```
...
menu_001,rest_001,불향 짬뽕,12000,/menus/menu_001.webp
menu_002,rest_001,옛날 짜장면,9000,/menus/menu_002.webp
menu_003,rest_002,아메리카노,4500,/menus/menu_003.webp
```

각 메뉴는 `restaurant_id`를 사용해 해당 음식점과 연결합니다. 메뉴 화면에는
이미지, 이름과 가격만 표시합니다.

### 데이터 작성 시 주의사항

- 음식점과 메뉴 ID는 한 번 정한 뒤 임의로 변경하지 않습니다.
- 가격을 확인한 날짜는 원본 데이터에 별도로 기록합니다.
