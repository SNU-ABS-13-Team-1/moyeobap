...
export type PhoneChatKind = "text" | "image";
...
type ChatRow = { id: string; author_id: string; author_name: string; author_role: PhoneChatAuthorRole | null; text: string; kind: PhoneChatKind; created_at: string };
...
export async function postRoomChat(roomId: string, userId: string, userName: string, text: string, kind: PhoneChatKind = "text"): Promise<PhoneChatMessage | { error: string }> {
