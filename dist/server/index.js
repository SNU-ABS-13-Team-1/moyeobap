globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-Cpw1AJ8I.js","assets/layout-segment-context-xOIP-Plw.js"];
...
function getDraftSecret() {
	return "2fbab1d1-64d9-4e88-8a92-a2c80126afc4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d09b4954-024b-4b2d-8459-c2b4dbe2f780";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d09b4954-024b-4b2d-8459-c2b4dbe2f780") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d09b4954-024b-4b2d-8459-c2b4dbe2f780",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata() {
	...
	const description = "음식점별 현재 인원을 보고 이미지, 이름과 가격으로 메뉴를 고르는 시흥캠퍼스 익명 수요 상황판";
	return {
		title,
		description,
		openGraph: {
